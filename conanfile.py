...
class PxrTfConan(ConanFile):
    name = "pxr-tf"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-tf"
    url = "https://github.com/untwine/pxr-tf"
    description = "Foundation tool for software development used in OpenUSD"
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-tf"]
        self.cpp_info.libs = ["PxrTf"]
