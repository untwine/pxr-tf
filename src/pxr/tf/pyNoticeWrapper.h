...
#ifndef PXR_TF_PY_NOTICE_WRAPPER_H
#define PXR_TF_PY_NOTICE_WRAPPER_H
...
{ \
    TF_NS::TfType::Define< TF_NS::TfPyNoticeWrapper<T, Base>, \
                           TF_NS::TfType::Bases<Base> >(); \
}

TF_NAMESPACE_CLOSE_SCOPE

#endif // PXR_TF_PY_NOTICE_WRAPPER_H
