...
#ifndef PXR_TF_ITERATOR_H
#define PXR_TF_ITERATOR_H
...
#define TF_FOR_ALL(iter, c) \
    for (auto iter = TF_NS::TfMakeIterator(c); iter; ++iter)
...
#define TF_REVERSE_FOR_ALL(iter, c) \
    for (auto iter = TF_NS::TfMakeReverseIterator(c); iter; ++iter)
