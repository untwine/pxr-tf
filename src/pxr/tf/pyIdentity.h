...
//
#ifndef PXR_TF_PY_IDENTITY_H
#define PXR_TF_PY_IDENTITY_H
...
struct pointee< pxr::TfWeakPtrFacade<X, Y> > {
    typedef Y type;
};

// TfRefPtr
template <typename T>
struct pointee< pxr::TfRefPtr<T> > {
    typedef T type;
};
