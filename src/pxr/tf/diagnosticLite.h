...
#define TF_CODING_ERROR                                                 \
    pxr::Tf_DiagnosticLiteHelper(TF_CALL_CONTEXT,                       \
...
#define TF_DIAGNOSTIC_WARNING                                                \
    pxr::Tf_DiagnosticLiteHelper(TF_CALL_CONTEXT.Hide(),                   \
        TF_DIAGNOSTIC_WARNING_TYPE).IssueWarning
...
#define TF_AXIOM(cond)                                                  \
    pxr::Tf_AxiomHelper(static_cast<bool>((cond)), TF_CALL_CONTEXT, #cond)

#define TF_DEV_AXIOM(cond)                                              \
    pxr::Tf_AxiomHelper(!ARCH_DEV_BUILD ||                              \
