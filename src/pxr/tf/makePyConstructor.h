...
#ifndef PXR_TF_MAKE_PY_CONSTRUCTOR_H
#define PXR_TF_MAKE_PY_CONSTRUCTOR_H
...
#define BOOST_PP_FILENAME_1 "pxr/tf/makePyConstructor.h"
...
#endif // PXR_TF_MAKE_PY_CONSTRUCTOR_H
