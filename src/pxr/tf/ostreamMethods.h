...
#ifndef PXR_TF_OSTREAM_METHODS_H
#define PXR_TF_OSTREAM_METHODS_H
...
typename std::enable_if<TF_NS::Tf_IsOstreamable<T>(), std::ostream &>::type
...
typename std::enable_if<
    TF_NS::Tf_IsOstreamable<K>() && TF_NS::Tf_IsOstreamable<M>(), std::ostream &>::type
operator<<(std::ostream &out, const TF_NS::TfHashMap<K, M, H, C, A> &h)
{
    out << "< ";
    for (auto const &p: h)
...
#endif // PXR_TF_OSTREAM_METHODS_H
