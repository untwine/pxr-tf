...
typename std::enable_if<pxr::Tf_IsOstreamable<T>(), std::ostream &>::type
...
typename std::enable_if<
    pxr::Tf_IsOstreamable<K>() && pxr::Tf_IsOstreamable<M>(), std::ostream &>::type
operator<<(std::ostream &out, const pxr::TfHashMap<K, M, H, C, A> &h)
{
    out << "< ";
    for (auto const &p: h)
