...
if __name__ == "__main__":
    ...
    parser.add_argument("--stdout-redirect", type=Path)
    ...
    stdout = args.stdout_redirect.open('w') if args.stdout_redirect else None
    try:
        print(f"cmd: {cmd}")
        retcode = subprocess.call(
            cmd, shell=False, env=env,
            stdout=(stdout or sys.stdout), stderr=sys.stderr
        )
